...
abstract contract StratX2_mod is Ownable, ReentrancyGuard, Pausable {
    ...
    address public farmContractAddress; // address of farm, eg, PCS, Thugs etc. master chef
    uint256 public pid; // pid of pool in farmContractAddress
    address public wantAddress; //LP address
    address public token0Address;//1st token of LP
    //address public token1Address;//2nd token of LP
    address public earnedAddress;//yielded token
    address public uniRouterAddress; // uniswap, pancakeswap etc

    //address public wbnbAddress;//wbnb
    address public autoFarmAddress;//address of autofarm v2
    ...
    uint256 public constant controllerFeeUL = 300;//UL=upper limit?
    ...
    */
    ...
    function earn() public virtual nonReentrant whenNotPaused {
        ...
        // Harvest farm tokens
        ISynapseh(farmContractAddress).harvest(pid,address(this));
        /*
       ...
       //uint256 token1Amt = IERC20(token1Address).balanceOf(address(this));
        if (token0Amt > 0) {
            ...
            */
            ...
            ISynapseLP(0xED2a7edd7413021d440b09D654f3b87712abAB66).addLiquidity(
                amt,
                minamt,
                block.timestamp.add(600)
            );
